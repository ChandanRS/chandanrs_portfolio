...
import { bounce,slideInRight,slideInLeft,fadeIn } from 'react-animations';
        ...
        <div id="about" className="banner">
            ...
            <div className="info">
              <div className="Name">
                ...
                <SlideRight className="banner-subtitle">A JavaScript Enthusiast && Web Developer</SlideRight>
              </div>
