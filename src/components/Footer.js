...
const Footer = () => {
    return (
        ...
        <section className="footer-container">
            ...
            <div className="mail">
            <p>If you would like to talk to me about something that could interest me, please send me an email at <a href="mailto:chandanshetti149@gmail.com" target="_blank"  rel="noreferrer">chandanshetti149@gmail.com</a>. </p>
